...
DB_USER="myuser"
DB_PASSWD=$(openssl rand -base64 12)  # Generate a random 12-character password
DB_HOST="db" # could be dns name, docker name or just ip
DB_PORT="5432"
DB_NAME="mydatabase"
...
DATABASE_URL="$DB_PROVIDER://$DB_USER:$DB_PASSWD@$DB_HOST:$DB_PORT/$DB_NAME"

# For external tools (like Drizzle Studio)
DATABASE_URL="$DB_PROVIDER://$DB_USER:$DB_PASSWD@$localhost:$DB_PORT/$DB_NAME"
...
echo "NEXT_PUBLIC_APP_URL=$DOMAIN" >> "$APP_DIR/.env
